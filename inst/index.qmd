...
intro <- tryCatch(
    {
        description <- packageDescription("BiocBookTesting")
...
👉 [ghcr.io/lmweber/biocbooktesting](https://ghcr.io/lmweber/biocbooktesting) 🐳
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbooktesting:devel bash
